...
def clean_text_for_pdf(text):
    """Sanitizes formatting for standard Latin-1 PDF output."""
...
def generate_pdf_one_page(text_content):
    ...
    # Standard margins and fonts for full-page fit
...
1. STRICT 1-PAGE LIMIT: Concise, high-impact bullet points filling the entire page properly.
...
4. SPANISH CV STRUCTURE (Modelo Español):
   ...
   - EXPERIENCIA PROFESIONAL: Reverse chronological order. Formatted as: Puesto | Empresa | Fechas (Enero 2022 - Presente) | Ciudad. Use strong Spanish action verbs (Lideré, Coordiné, Implementé, Gestioné, Optimizé).
